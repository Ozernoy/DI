...
class Farm:
    ...
    def get_short_info(self):
        ...
        animal_types_plural = [f"{animal}s" for animal in animal_types]
        animal_str = ", ".join(animal_types_plural[:-1]) + f" and {animal_types_plural[-1]}"
...
print(macdonald.get_short_info())  # Output: "McDonald’s farm has cows, goats and sheeps."
